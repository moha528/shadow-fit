...
import DashboardSection from "@/components/ImmersiveExperienceSection";
import ImmersiveExperienceSection from "@/components/ImmersiveExperienceSection";
import SolutionSection from "@/components/ImmersiveExperienceSection";
import AboutSection from "@/components/ImmersiveExperienceSection";
      ...
      <section id="features" className="w-full py-12 md:py-24 border-b border-zinc-800">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center gap-4 text-center md:pb-16">
            <Badge className="bg-gray-500/10 text-gray-500 border-gray-500/20 mb-2">Ce que ShadowFit t'apporte</Badge>
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
              Ton évolution, à ta manière
            </h2>
            <p className="max-w-[700px] text-zinc-400 md:text-xl/relaxed">
              ShadowFit, c’est pas juste une appli de sport. C’est ton espace pour suivre ton corps, progresser à ton
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            ...
            <div className="flex flex-col gap-2 p-6 bg-zinc-900 rounded-xl border border-zinc-800">
              ...
              <p className="text-zinc-400">
                Suis l’évolution de ton corps avec une vue 3D stylée. Les muscles que tu bosses s’illuminent en fonction
                de tes efforts.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="flex flex-col gap-2 p-6 bg-zinc-900 rounded-xl border border-zinc-800">
              ...
              <p className="text-zinc-400">
                L’IA capte ce que tu fais et t’aide à progresser sans te casser la tête. Elle ajuste tes séances au bon
                moment.
              </p>
            </div>
            {/* Feature 3 */}
            ...
            <div className="flex flex-col gap-2 p-6 bg-zinc-900 rounded-xl border border-zinc-800">
              ...
              <p className="text-zinc-400">
                Gagne des badges, monte de niveau, débloque des récompenses… tout en t’entraînant. Simple et motivant.
              </p>
            </div>
            {/* Feature 5 */}
            <div className="flex flex-col gap-2 p-6 bg-zinc-900 rounded-xl border border-zinc-800">
              ...
              <p className="text-zinc-400">
                ShadowFit te signale si tu tires trop ou si t’as un déséquilibre. Tu progresses sans te blesser.
              </p>
            </div>
